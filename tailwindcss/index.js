        ...
        btn: theme => Object.assign({
            ...
            sizes: {
                'xs': {
                    padding: '.15rem .35rem',
                    fontSize: '.75rem',
                    borderRadius: theme('form.borderRadius') && '.2rem',
                },
                ...
                'xl': {
                    ...
                    fontSize: '1.33rem',
                    borderRadius: theme('form.borderRadius') && '.33rem',
                },
    
                '2xl': {
                    padding: '.75rem 1.5rem',
                    fontSize: '1.5rem',
                    borderRadius: theme('form.borderRadius') && '.5rem',
                },
                ...
                '4xl': {
                    padding: '1rem 2rem',
                    fontSize: '2rem',
                    borderRadius: theme('form.borderRadius') && '.66rem',
                }
            }
        })
    }
